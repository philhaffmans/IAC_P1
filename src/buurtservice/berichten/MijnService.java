 ...
 * 
 */
@WebServiceClient(name = "mijnService", targetNamespace = "http://buurtservice/berichten/", wsdlLocation = "file:/Users/philippehaffmans/Documents/Git/IAC_P1_V2/src/service.wsdl")
    ...
    extends Service
{
    ...
    private final static QName MIJNSERVICE_QNAME = new QName("http://buurtservice/berichten/", "mijnService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/Users/philippehaffmans/Documents/Git/IAC_P1_V2/src/service.wsdl");
    ...
    public WSInterface getWSPort() {
        return super.getPort(new QName("http://buurtservice/berichten/", "WS-Port"), WSInterface.class);
    }
    ...
    public WSInterface getWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://buurtservice/berichten/", "WS-Port"), WSInterface.class, features);
    }
